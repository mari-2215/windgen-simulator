...
| Phase 1.4 | Operational bench application | Guarded Bench Test 3 execution, plots, commands, and logs |
| Phase 1.5 | Neural/endurance Bench Test 4 | Prompt control, 10 min run, 1-4 motor layout, RPM record |
| Phase 1.6 | Bench Test 5 with wind feedback | Serial/simulated anemometer, proportional correction, and app |
| Phase 1.7 | Instrumented bench application | RPM reading, wireless telemetry, and visible stop |
